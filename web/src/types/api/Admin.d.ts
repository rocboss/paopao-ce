    ...
    interface Api {
      post: {
        user: {
          /** 管理·用户禁言/解禁 */
          status: (
            params: NetParams.UserStatusReq,
          ) => Promise<NetReq.UserChangeStatus>;
        };
        site: {
          /** 管理·更新系统配置 */
          profile: (
            params: NetParams.SiteProfileReq,
          ) => Promise<NetReq.SiteProfileResp>;
        };
        settings: {
          /** 管理·保存通用配置 */
          save: (
            params: NetParams.SettingsSaveReq,
          ) => Promise<NetReq.SettingsSaveResp>;
        };
      };
      get: {
        site: {
